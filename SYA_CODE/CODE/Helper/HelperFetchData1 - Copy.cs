...
//{
//    public class HelperFetchData13
//    {
...
//                if (dt.Rows.Count > 0)
//                {
//                    // Skip processing if the tag exists in MAIN_TAG_DATA for CO_CODE 026 or 027
//                    foreach (DataRow dr in dt.Rows)
//                    {
//                        if (RecordExists(dr))
//                        {
//                            ExecuteUpdateQueryForSales(MapDataToSQLiteParametersForSales(dr));
//                            updatedRows++;
//                        }
//                        else
//                        {
//                            ExecuteInsertQueryForSales(MapDataToSQLiteParametersForSales(dr));
//                            insertedRows++;
//                            skippedRows++;
//                        }
//                    }
...
//                else
//                {
//                    // Delete existing row in MAIN_DATA_NEW if present
//                    if (RecordExists(row))
//                    {
//                        ExecuteUpdateQuery(MapDataToSQLiteParameters(row));
//                        updatedRows++;
//                    }
//                    else
//                    {
//                        ExecuteInsertQuery(MapDataToSQLiteParameters(row));
//                        insertedRows++;
//                    }
//                }
...
//        {
//            // Adjusted query to fetch additional columns ITM_RAT, ITM_AMT, AC_CODE, IT_DESC
...
//            string query = $"SELECT * FROM MAIN_DATA_NEW WHERE TAG_NO = '{tagNo}' AND CO_YEAR = '{coYear}'";
...
//            helper.RunQueryWithoutParametersSYADataBase(query, "ExecuteNonQuery");
//        }

//        public List<SQLiteParameter> MapDataToSQLiteParameters(DataRow accessDataRow)
//        {
//            var sqliteParameters = new List<SQLiteParameter>();
//            sqliteParameters.Add(new SQLiteParameter("@CO_YEAR", accessDataRow["CO_YEAR"] ?? ""));
//            sqliteParameters.Add(new SQLiteParameter("@CO_BOOK", accessDataRow["CO_BOOK"] ?? ""));
//            sqliteParameters.Add(new SQLiteParameter("@VCH_NO", accessDataRow["VCH_NO"] ?? ""));
//            sqliteParameters.Add(new SQLiteParameter("@VCH_DATE", accessDataRow["VCH_DATE"] ?? ""));
...
//        {
//            return @"INSERT INTO MAIN_DATA_NEW (CO_YEAR, CO_BOOK, VCH_NO, VCH_DATE, PURITY, METAL_TYPE, TAG_NO, DESIGN, ITM_SIZE, ITM_PCS, GW, NW, LBR_RATE, OTH_AMT, LBR_AMT, HUID1, HUID2, HUID3, ITEM_TYPE, SIZE, PRICE, COMMENT)
//             VALUES (@CO_YEAR, @CO_BOOK, @VCH_NO, @VCH_DATE, @PURITY, @METAL_TYPE, @TAG_NO, @DESIGN, @ITM_SIZE, @ITM_PCS, @GW, @NW, @LBR_RATE, @OTH_AMT, @LBR_AMT, @HUID1, @HUID2, @HUID3, @ITEM_TYPE, @SIZE, @PRICE, @COMMENT)";
//        }

//        public string GenerateUpdateQuery()
//        {
//            return @"UPDATE MAIN_DATA_NEW 
//             SET CO_BOOK = @CO_BOOK, 
//                 VCH_NO = @VCH_NO, 
//                 VCH_DATE = @VCH_DATE, 
//                 PURITY = @PURITY, 
...
//             WHERE TAG_NO = @TAG_NO AND CO_YEAR = @CO_YEAR";
//        }

//        public void ExecuteUpdateQuery(List<SQLiteParameter> parameters)
//        {
//            string query = GenerateUpdateQuery();
//            helper.RunQueryWithParametersSYADataBase(query, parameters.ToArray());
//        }

//        public void ExecuteInsertQuery(List<SQLiteParameter> parameters)
//        {
...
//            // sqliteParameters.Add(new SQLiteParameter("@IT_DESC", accessDataRow["IT_DESC"] ?? ""));
...
//        public string GenerateInsertQueryForSales()
//        {
//            return @"INSERT INTO SALE_DATA_NEW (CO_YEAR, CO_BOOK, VCH_NO, VCH_DATE, PURITY, METAL_TYPE, TAG_NO, DESIGN, ITM_SIZE, ITM_PCS, GW, NW, LBR_RATE, OTH_AMT, LBR_AMT, HUID1, HUID2, HUID3, ITEM_TYPE, SIZE, PRICE, COMMENT,ITM_RAT,ITM_AMT,AC_CODE)
//             VALUES (@CO_YEAR, @CO_BOOK, @VCH_NO, @VCH_DATE, @PURITY, @METAL_TYPE, @TAG_NO, @DESIGN, @ITM_SIZE, @ITM_PCS, @GW, @NW, @LBR_RATE, @OTH_AMT, @LBR_AMT, @HUID1, @HUID2, @HUID3, @ITEM_TYPE, @SIZE, @PRICE, @COMMENT,@ITM_RAT,@ITM_AMT,@AC_CODE)";
//        }

//        public string GenerateUpdateQueryForSales()
//        {
//            return @"UPDATE SALE_DATA_NEW 
//             SET CO_BOOK = @CO_BOOK, 
//                 VCH_NO = @VCH_NO, 
//                 VCH_DATE = @VCH_DATE, 
//                 PURITY = @PURITY, 
...
//        public void ExecuteUpdateQueryForSales(List<SQLiteParameter> parameters)
//        {
//            string query = GenerateUpdateQueryForSales();
//            helper.RunQueryWithParametersSYADataBase(query, parameters.ToArray());
//        }

//        public void ExecuteInsertQueryForSales(List<SQLiteParameter> parameters)
//        {
//            string query = GenerateInsertQueryForSales();
//            helper.RunQueryWithParametersSYADataBase(query, parameters.ToArray());
//        }
//    }
//}
