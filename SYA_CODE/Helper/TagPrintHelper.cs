...
namespace SYA.Helper
{
    public static class TagPrintHelper
    {
        ...
        {
            e.Graphics.DrawString(value, new Font("Arial", (float)13.5, FontStyle.Bold), brush, new RectangleF(8, 4, (float)165, (float)22.5), new StringFormat() { Alignment = StringAlignment.Near, LineAlignment = StringAlignment.Near });
        }
        public static void FramesPrice(string value, PrintPageEventArgs e)
        {
            e.Graphics.DrawString(value, new Font("Arial", (float)15    , FontStyle.Bold), brush, new RectangleF(8, (float)26, (float)165, (float)22.5), new StringFormat() { Alignment = StringAlignment.Near, LineAlignment = StringAlignment.Near });
        }
